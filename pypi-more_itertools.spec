...
Source0  : https://files.pythonhosted.org/packages/01/33/77f586de725fc990d12dda3d4efca4a41635be0f99a987b9cc3a78364c13/more-itertools-10.3.0.tar.gz
...
%prep
%setup -q -n more-itertools-10.3.0
cd %{_builddir}/more-itertools-10.3.0
pushd ..
cp -a more-itertools-10.3.0 buildavx2
popd
pushd ..
cp -a more-itertools-10.3.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718229455
