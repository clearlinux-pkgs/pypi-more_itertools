...
Source0  : https://files.pythonhosted.org/packages/2e/d0/bea165535891bd1dcb5152263603e902c0ec1f4c9a2e152cc4adff6b3a38/more-itertools-9.1.0.tar.gz
...
%prep
%setup -q -n more-itertools-9.1.0
cd %{_builddir}/more-itertools-9.1.0
pushd ..
cp -a more-itertools-9.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677546193
